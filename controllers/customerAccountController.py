...
from services.customerAccountService import (
    create_account,
    get_account,
    update_account,
    delete_account,
    find_all_accounts,
    find_all_accounts_paginate
)
...
def create_account():
    ...
    new_account = create_account(account_data)
...
def update_account(account_id):
    ...
    updated_account = update_account(account_id, account_data)
    if updated_account:
...
def find_all_accounts_paginate():
    ...
    accounts = find_all_accounts_paginate(page, per_page)
